...
export default function FAQ() {
  ...
  return (
    <div id="faq" className="px-4 sm:px-8 py-12 sm:py-16 lg:py-24 max-w-7xl mx-auto">
      ...
      <div className="mt-6 border-t border-gray-300">
        <dl className="divide-y divide-gray-300">
          {faqs.map((item, i) => (
            <div key={`faq-${i}`} id={`faq-${i}`} className="px-2 sm:px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">

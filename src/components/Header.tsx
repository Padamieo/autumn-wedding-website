        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative px-3 py-1 text-sm/6 text-gray-600 hover:ring-gray-900/20">
              Heather & Adam are very HAPPY to announce
            </div>
          </div>
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">
              WE ARE GETTING MARRIED, FOR REAL
            </h1>
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a href="#details" className="text-sm/6 font-semibold text-gray-900 flex">
                Give me the deets <span aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/></svg></span>
              </a>
            </div>
          </div>
        </div>
